...
abstract class AppLocalizations {
  ...
  /// No description provided for @accessModeTitle.
  ///
  /// In es, this message translates to:
  /// **'Modo de acceso'**
  String get accessModeTitle;

  /// No description provided for @accessModeOpenTitle.
  ///
  /// In es, this message translates to:
  /// **'Abierto'**
  String get accessModeOpenTitle;

  /// No description provided for @accessModeOpenDescription.
  ///
  /// In es, this message translates to:
  /// **'Los usuarios ven el listado completo y pueden solicitar unirse.'**
  String get accessModeOpenDescription;

  /// No description provided for @accessModeInviteOnlyTitle.
  ///
  /// In es, this message translates to:
  /// **'Solo por invitación'**
  String get accessModeInviteOnlyTitle;

  /// No description provided for @accessModeInviteOnlyDescription.
  ///
  /// In es, this message translates to:
  /// **'Solo ven sus grupos/ministerios e invitaciones pendientes.'**
  String get accessModeInviteOnlyDescription;

  /// No description provided for @accessModeUpdated.
  ///
  /// In es, this message translates to:
  /// **'Modo de acceso actualizado'**
  String get accessModeUpdated;
  ...
  /// No description provided for @myMinistries.
  ///
  /// In es, this message translates to:
  /// **'Mis ministerios'**
  String get myMinistries;

  /// No description provided for @mediaSendPermissionsTitle.
  ///
  /// In es, this message translates to:
  /// **'Permisos para enviar fotos y videos'**
  String get mediaSendPermissionsTitle;

  /// No description provided for @postPermissionsTitle.
  ///
  /// In es, this message translates to:
  /// **'Permisos para publicar'**
  String get postPermissionsTitle;

  /// No description provided for @allowedMembersCount.
  ///
  /// In es, this message translates to:
