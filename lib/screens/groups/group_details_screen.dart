...
import '../groups/group_event_detail_screen.dart';
import 'widgets/edit_description_dialog.dart';
...
class _GroupDetailsScreenState extends State<GroupDetailsScreen> {
  ...
  Future<void> _checkAdminStatus() async {
    ...
    if (currentUser != null) {
      ...
      setState(() {
        isAdmin = widget.group.groupAdmin.contains(userRef);
      });
    }
  }
                ...
                children: [
                  StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final currentImageUrl = groupData['imageUrl'] as String? ?? '';
                      ...
                      return CircularImagePicker(
                        ...
                        fieldName: 'imageUrl',
                        defaultIcon: const Icon(Icons.group, size: 60),
                        isEditable: isAdmin,
                      );
                    },
                  ),
                  ...
                  StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        .collection('users')
                        .where(FieldPath.documentId, whereIn: widget.group.members.map((ref) => ref.id).toList())
                        .snapshots(),
                    builder: (context, snapshot) {
                      ...
                      if (isAdmin) IconButton(
                        ...
                        onPressed: () {
                          showModalBottomSheet(
                            ...
                            builder: (context) => CreateGroupEventModal(
                              group: widget.group,
                            ),
                          );
                        },
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final event = GroupEvent.fromFirestore(events[index]);
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              trailing: widget.group.groupAdmin.contains(members[index].reference)
                                  ? Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    label: const Text('Report Group'),
                    onPressed: () {
                      // TODO: Implementar la lógica para reportar el grupo
                    },
                    style: TextButton.styleFrom(
