...
class CreateMinistryEventModal extends StatefulWidget {
  ...
  const CreateMinistryEventModal({
    super.key,
    required this.ministry,
  });

  @override
  State<CreateMinistryEventModal> createState() => _CreateMinistryEventModalState();
}

class _CreateMinistryEventModalState extends State<CreateMinistryEventModal> {
  ...
  Future<void> _createEvent() async {
    ...
    // Capturar servicio antes de operaciones asíncronas
    ...
    try {
      ...
      // Crear evento
      final eventId = await _eventService.createMinistryEvent(
      ...
      // Enviar notificación (usando servicio capturado, sin check de mounted)
      try {
        await notificationService.sendMinistryNewEventNotification(
          ministryId: widget.ministry.id,
        ...
        print('Error enviando notificación de evento: $e');
      }
